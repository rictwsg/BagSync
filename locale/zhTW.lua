...
L.ON = "開[ON]"
L.OFF = "關[OFF]"
L.LeftClickSearch = "左鍵 = 搜尋視窗"
L.RightClickBagSyncMenu = "右鍵 = 選單"
L.RightClickInsertTradeskill = "右鍵 = 插入專業技能連結"
...
L.HelpSearchItemName = "/bgs [物品名稱] - 快速搜尋一件物品"
L.HelpSearchWindow = "/bgs search - 開啟搜尋視窗"
...
L.HelpBlacklistWindow = "/bgs blacklist - 開啟忽略清單"
L.DisplayTotal = "在金錢和統計上顯示總數"
L.DisplayGuildName = "在資訊上顯示公會名"
L.DisplayGuildBank = "包括公會倉庫物品"
...
L.DisplayTooltipOnlySearch = "僅在BagSync搜尋視窗內顯示修改過的提示資訊"
L.EnableBagSyncTooltip = "啟用BagSync提示資訊"
L.DisplayLineSeperator = "在提示資訊上方添加空白分割線"
